	...
	<div class="col-12">
		<div class="col-lg-12 col-sm-12" align="center">
			<a class="navbar-brand js-scroll-trigger" href="index.php">
				<img class="logo mb-2 mt-3" width="200" height="auto" src="<?= URL_HOME; ?>assets/img/MyBusinessSalesManager.png" />
				<span></span>
			</a>
			...
			<ul class="navbar-nav text-center" style="margin:0 auto;">
				...
				<li class="nav-item dropdown">
				  ...
				  <UL class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					?>
					<li class="dropdown-item">
						<a href="sair.php" class="nav-link" style="color: #000;">Sair</a>
					</li>
				  </UL>
				</li>
			</ul>
